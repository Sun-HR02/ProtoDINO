...
def predict(
        ...
        device: str = "cuda",
        remove_combined: bool = False,counter = 0
    ...
    prediction_features = outputs['target_features'][0] # prediction_features.shape = (nq, 256)
...
def predict_with_features(
    ...
    # # 修改为直接使用全部预测结果（不使用mask）
    # logits = prediction_logits  # 使用所有logits
    # boxes = prediction_boxes    # 使用所有boxes
    # features = prediction_features  # 使用所有features
